...
description: |
  Home page for the Graphics Principles cheatsheet
...
** This is the landing page for the [Graphics Principles cheatsheet](https://github.com/GraphicsPrinciples/CheatSheet/blob/master/NVSCheatSheet.pdf).
