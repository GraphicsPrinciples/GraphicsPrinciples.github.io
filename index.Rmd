...
We also have published a [tutorial](tutorial.html) on "Effective visual communication for the quantitative scientist", which can be found [at CPT:PSP here](https://ascpt.onlinelibrary.wiley.com/doi/10.1002/psp4.12455). Example code for the [case studies](https://graphicsprinciples.github.io/tutorial-case-studies) are also available [here](https://github.com/GraphicsPrinciples/tutorial-viz-com). 
